...
Ev_max_nComp_ME11 = TH1F("Ev_max_nComp_ME11","Max nComp per Event in a Single Sector in ME1/1", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME11)
Ev_max_nComp_ME12 = TH1F("Ev_max_nComp_ME12","Max nComp per Event in a Single Sector in ME1/2", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME12)
Ev_max_nComp_ME21 = TH1F("Ev_max_nComp_ME21","Max nComp per Event in a Single Sector in ME2/1", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME21)
Ev_max_nComp_ME22 = TH1F("Ev_max_nComp_ME22","Max nComp per Event in a Single Sector in ME2/2", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME22)
Ev_max_nComp_ME31 = TH1F("Ev_max_nComp_ME31","Max nComp per Event in a Single Sector in ME3/1", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME31)
Ev_max_nComp_ME32 = TH1F("Ev_max_nComp_ME32","Max nComp per Event in a Single Sector in ME3/2", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME32)
Ev_max_nComp_ME41 = TH1F("Ev_max_nComp_ME41","Max nComp per Event in a Single Sector in ME4/1", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME41)
Ev_max_nComp_ME42 = TH1F("Ev_max_nComp_ME42","Max nComp per Event in a Single Sector in ME4/2", 150, -.5, 149.5); hists.append(Ev_max_nComp_ME42)

Ev_max_nWire_ME11 = TH1F("Ev_max_nWire_ME11","Max nWire per Event in a Single Sector in ME1/1", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME11)
Ev_max_nWire_ME12 = TH1F("Ev_max_nWire_ME12","Max nWire per Event in a Single Sector in ME1/2", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME12)
Ev_max_nWire_ME21 = TH1F("Ev_max_nWire_ME21","Max nWire per Event in a Single Sector in ME2/1", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME21)
Ev_max_nWire_ME22 = TH1F("Ev_max_nWire_ME22","Max nWire per Event in a Single Sector in ME2/2", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME22)
Ev_max_nWire_ME31 = TH1F("Ev_max_nWire_ME31","Max nWire per Event in a Single Sector in ME3/1", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME31)
Ev_max_nWire_ME32 = TH1F("Ev_max_nWire_ME32","Max nWire per Event in a Single Sector in ME3/2", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME32)
Ev_max_nWire_ME41 = TH1F("Ev_max_nWire_ME41","Max nWire per Event in a Single Sector in ME4/1", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME41)
Ev_max_nWire_ME42 = TH1F("Ev_max_nWire_ME42","Max nWire per Event in a Single Sector in ME4/2", 150, -.5, 149.5); hists.append(Ev_max_nWire_ME42)
